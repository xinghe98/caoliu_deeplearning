import { Heart, SkipForward, ThumbsDown } from 'lucide-react'
  ...
  return (
    <>
      <div className="grid gap-7 p-5 md:grid-cols-[minmax(0,1fr)_auto] md:p-7">
        ...
        <p className="hidden text-xs text-muted md:block md:pl-7">快捷键：1 喜欢 · 2 不喜欢 · 3 跳过 · M 复制 · ←/→ 切图 · Z 撤销</p>
      </div>

      <MobileLabelBar busy={busy} onLike={onLike} onDislike={onDislike} onSkip={onSkip} />
    </>
  )
}
